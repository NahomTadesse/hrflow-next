...
export default function DarkMode() {
  ...
  return (
    <div className="fixed top-4 right-32 z-[9999]">
      {" "}
      <button
        onClick={toggleTheme}
        ...
        <div className="relative w-8 h-8">
          ...
          >
            ...
            <div className="relative w-7 h-7">
              ...
              >
                ...
                <div className="absolute inset-0 animate-pulse">
                  {[...Array(4)].map((_, i) => (
                    <div
                      key={i}
                      className="absolute top-1/2 left-1/2 w-0.5 h-3 bg-amber-400/50 rounded-full"
                      style={{
              ...
              >
                <Moon className="w-full h-full stext-blue-300" />
